...
as_kable_extra(table1)%>%kable_styling(latex_options = "HOLD_position") 
as_kable_extra(table2)%>%kable_styling(latex_options = "HOLD_position")  
...
stargazer(model_1_1,model_1_2, model_1_3, model_1_4, model_1_5,
          ...
          se = list(get_robust_se(model_1_1),get_robust_se(model_1_2), get_robust_se(model_1_3), get_robust_se(model_1_4),    get_robust_se(model_1_5)),
          out='models1.htm')
...
stargazer(model_2_1,model_2_2, model_2_3, model_2_4, model_2_5, 
          covariate.labels=c("Male Instructor Video","Age: 30-40","Age: 40-50", "Age: 50+", "Male","Constant"),
          dep.var.labels=c("Average Rating","Instructor","Subject","Material","Enthusiasm"),
          se = list(get_robust_se(model_2_1),get_robust_se(model_2_2), get_robust_se(model_2_3), get_robust_se(model_2_4),    get_robust_se(model_2_5)),
...
stargazer(model_3_1,model_3_2, model_3_3, model_3_4, model_3_5,
          covariate.labels=c("Male Instructor Video","Age: 30-40","Age: 40-50", "Age: 50+", "Male","Male:Male Instructor Video","Constant"),
          dep.var.labels=c("Average Rating","Instructor","Subject","Material","Enthusiasm"),
          se = list(get_robust_se(model_3_1),get_robust_se(model_3_2), get_robust_se(model_3_3), get_robust_se(model_3_4),    get_robust_se(model_3_5)),
...
```
$Quiz \ Score=\beta_0+\beta_1 Male Instructor Video$

$Quiz \ Score=\beta_0+\beta_1 Male Instructor Video \ +\beta_2Age:30-40\ +\beta_3Age:40-50\ +\beta_4Age:50+\beta_5Male$

$Quiz \ Score=\beta_0+\beta_1 Male Instructor Video \ +\beta_2Age:30-40\ +\beta_3Age:40-50\ +\beta_4Age:50+\beta_5Male +\beta_6(Male*MaleInstructorVideo)$
...
model_4_2 <- lm(quiz_avg ~ assignment+as.factor(Age) + as.factor(Gender), data=d)
model_4_3 <- lm(quiz_avg ~ assignment + as.factor(Age) + as.factor(Gender) +as.factor(Gender)*assignment, data=d)
...
stargazer(model_4_1, model_4_2,model_4_3, 
          ...
          se = list(get_robust_se(model_4_1),get_robust_se(model_4_2), get_robust_se(model_4_3)),
          title = 'Table 7: Quiz Score Models',
