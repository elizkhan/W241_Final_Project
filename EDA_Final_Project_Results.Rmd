...
d <- fread("survey_data_as_of_11_01_21_10AM.csv")
...
cols <- c("ResponseId","Gender","Age","Education","instr_enthusiasm","instr_professional", "instr_subject","instr_material","instr_rating","subject_1","subject_2","subject_3","subject_4","video_watched")
