...
treatment_avg = round(mean(d[(Age==age)&(assignment=='Treatment'),instr_rating]),2)
control_avg = round(mean(d[(Age==age)&(assignment=='Control'),instr_rating]),2)
p_val =round(t.test(d[(Age==age)&(assignment=='Treatment'),instr_rating], d[(Age==age)&(assignment=='Control'),instr_rating], conf.level = 0.95)$p.value,3)
...
{ print(gender)
treatment_avg =round(mean(d[(Gender==gender)&(assignment=='Treatment'),avg_rating]),2)
control_avg =round(mean(d[(Gender==gender)&(assignment=='Control'),avg_rating]),2)
p_val =round(t.test(d[(Gender==gender)&(assignment=='Treatment'),avg_rating], d[(Gender==gender)&(assignment=='Control'),avg_rating], conf.level = 0.95)$p.value,3)
...
{ print(education)
treatment_avg =round(mean(d[(Education==education)&(assignment=='Treatment'),avg_rating]),2)
control_avg =round(mean(d[(Education==education)&(assignment=='Control'),avg_rating]),2)
if (education!= 'Less than High school') {
p_val =round(t.test(d[(Education==education)&(assignment=='Treatment'),avg_rating], d[(Education==education)&(assignment=='Control'),avg_rating], conf.level = 0.95)$p.value,3)}
else {p_val = NA}
...
print(final, cname = c("Control (N = 108)","Treatment (N = 113)", "Mean Rating - Control", "Mean Rating - Treatment", "P-value"),digits=3)
```
...
model_1_2 <- lm(avg_rating ~ assignment, data=d)
model_1_3 <- lm(avg_rating ~ assignment, data=d)
model_1_4 <- lm(avg_rating ~ assignment, data=d)
model_1_5 <- lm(avg_rating ~ assignment, data=d)
